        ...
        <div className="flex-grow py-10 bg-background dark:bg-neutral-dark">
          {state.error ? (
            <div className="flex flex-col items-center justify-center h-full px-4">
              <h1 className="text-2xl font-bold text-error dark:text-error-dark">
              ...
              <button
                onClick={logOut}
                className="bg-primary hover:bg-primary-dark text-white font-bold py-2 px-4 rounded mt-6 shadow-md transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary-light focus:ring-offset-2"
              >
